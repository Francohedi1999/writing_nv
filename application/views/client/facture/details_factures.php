	...
	<div class="contenu_global">
		...
		<div class="contenu">
			<div class="p-2">
					...
					<div class="tableau">
						<table class="table table-bordered mt-2">
			  				...
			  				<tr>
			  					...
			  					<td><?php echo $facture['type_paiement'] ;?></td>
				...
				<a href="<?php echo site_url('Client/details_commande/'.$facture['id_commande']);?>" class="btn btn-primary mb-4">Voir la commande</a>
