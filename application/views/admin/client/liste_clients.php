	...
	<div class="contenu_global">
		...
		<div class="contenu">
			...
			<div class="p-2">
				...
				<hr>
				<form class="container-fluid mt-4" method="post" action="<?php echo site_url('Admin/clients');?>">
						<div class="form-row">
	      		...
	      		<table class="table table-bordered mt-3">
					<thead class="table-secondary">
						<tr>
							...
							<th scope="col" width="150" width="50"></th>
						</tr>
					</thead>
					<tbody>
				...
				<nav>
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link" href="<?php echo site_url('Admin/clients/'.$e);?>"><?php echo $e; ?></a></li>
						<?php }?>
					</ul>
				</nav>
