	...
	<div class="contenu_global">
		...
		<div class="contenu">
			...
			<div class="p-2">
				...
				<fieldset>
					<legend>
						<h5 align="center">Modification langue</h5>
					</legend>
					<hr>
					<form action="<?php echo site_url('Admin/modification_langue/');?>" method="post">
						<div class="form-group mt-2">
							<label>Langue</label>
							<input type="hidden" name="id_langue_text" value="<?php echo $langue['id_langue_text'];?>" class="form-control">
							<input type="text" name="langue_text" value="<?php echo $langue['langue_text'];?>" class="form-control">
