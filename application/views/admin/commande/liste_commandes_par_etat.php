...
<body>
	...
	<div class="contenu_global">
		...
		<div class="contenu">
			<div class="p-2">
					<h4 align="center" class="mt-4 mb-3">Commandes<?php echo "<br>(".$titre_etat_commande['etat_commande'].")" ;?></h4>
					<hr>
	      			<form class="container-fluid mt-2" method="post" action="<?php echo site_url('Admin/etat_commandes/'.$id_etat_commande);?>">
	      				<div class="form-row">
					...
					<form class="container-fluid mt-4" method="post" action="<?php echo site_url('Admin/etat_commandes/'.$id_etat_commande);?>">
						<div class="form-row">
							<div class="form-group col-md-2">
							</div>
						    <div class="input-group form-group col-md-8">
						    	...
						    	<div class="input-group"> 
									<select name="filtre" class="form-control">
									    <option value="id_commande desc">Décroissante</option>
									    <option value="id_commande asc">Croissante</option>
									</select>
								</div>
							</div>
						    <div class="form-group col-md-2">
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							...
							<li class="page-item"><a class="page-link" href="<?php echo site_url('Admin/etat_commandes/'.$id_etat_commande.'/'.$e);?>"><?php echo $e; ?></a></li>
							<?php }?>
						</ul>
					</nav>
