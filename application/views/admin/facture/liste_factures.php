	...
	<div class="contenu_global">
		...
		<div class="contenu">
			...
			<div class="p-2">
				...
				<h4 align="center" class="mt-2 mb-3">Factures</h4>
				<hr>
				<form class="container-fluid mt-4" method="post" action="<?php echo site_url('Admin/factures/');?>">
					<div class="form-row">
				...
				<table class="table table-bordered mt-3">
					<thead class="table-secondary">
						<tr>
							...
							<th scope="col" width="150">Prix (Ar)</th>
							<th scope="col" width="150">Facturation</th>
					...
					<tr>
						...
						<td>
							<a href="<?php echo site_url('Admin/details_facture/'.$factures[$i]['id_facture'] );?>" class="btn btn-outline-primary">
								Voir
							</a>
						</td>
					</tr>
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link" href="<?php echo site_url('Admin/factures/'.$e);?>"><?php echo $e; ?></a></li>
						<?php }?>
					</ul>
				</nav>
