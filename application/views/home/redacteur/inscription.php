				...
				<div class="form_insc">
					...
					<div class="my-3">
						...
						<?php if(isset($error_mail)){?>
							<span><div class="alert alert-danger" role="alert"><?php echo $error_mail; ?></div></span>
						<?php }?>
						...
						<span><?php echo form_error('id_type_redacteur' , '<p class="alert-danger rounded px-2 py-1" role="alert">' , '</p>'); ?></span>
					...
					<form method="post" action="<?php echo site_url('home/register_redacteur'); ?>">		
						   ...
						   <ul class="etape">   
						      	...
						      	<li class="my-2">
						      		...
						      		<div id="insc_1" class="shadow my-4 p-2 rounded">
										...
										<div class="row">
											<div class="col">
												<label>Nom de plume</label>
												<input name="nom_plume" class="form-control mb-3" type="text">
											</div>
											<div class="col">
						      	...
						      	<li class="my-2">
						      		...
						      		<div id="insc_3" class="shadow my-4 p-2 rounded">
										...
										<hr>
										<label>Langues de rédaction</label>
										<select name="id_langue_text" id="id_langue_text"  class="form-control mb-3">
										<?php for($y=0 ; $y<count($langues_text) ; $y++) {?>
											<option value="<?php echo $langues_text[$y]['id_langue_text'];?>"><?php echo $langues_text[$y]['langue_text'] ;?></option>
										<?php }?>					
										</select>			
										
										<label>Veuillez choisir à quel type de rédacteur vous correspondez </label>										
										<select name="id_type_redacteur" id="id_type_redacteur"  class="form-control mb-3">
										<?php for($i=0 ; $i<count($types_redacteur) ; $i++) {?>
											<option value="<?php echo $types_redacteur[$i]['id_type_redacteur'];?>"><?php echo $types_redacteur[$i]['type_redacteur'] ;?></option>
										<?php }?>					
										</select>
								...
								<li class="my-2">
						      		<a class="btn btn-light" onclick="open_form_motif( 'insc_5' )">Etape 5 <i class="fa fa-angle-down" style="color:black;"></i></a>

						      		<div id="insc_5" class="shadow my-4 p-2 rounded">		
										
										<a onclick="close_form_motif( 'insc_5' )" class="btn btn-white">							
											<i class="fa fa-close" style="color:black;"></i>
										</a>
										<hr>
										<br>
