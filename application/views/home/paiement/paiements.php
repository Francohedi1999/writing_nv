		...
		<div class="contenu">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card">
						<?php for($i=0 ; $i<count($types_paiement) ; $i++) {?>
						<dl class="row m-2">
						  	<dt class="col-sm-4"><?php echo $types_paiement[$i]['type_paiement'] ;?></dt>
						  	<dd class="col-sm-8">
						    	<p></p>
						    	<p><?php echo $types_paiement[$i]['desc_type_paiement'] ;?></p>
						  	</dd>
						</dl>
						<?php }?>
					</div>
			...
			<nav aria-label="Page navigation example" class="ml-2">
				...
				<?php for($e=1 ; $e<=$nb_pages ; $e++) {?>	
					<li class="page-item"><a class="page-link" href="<?php echo site_url('Home/paiements/'.$e);?>"><?php echo $e; ?></a></li>
				<?php }?>
				</ul>
			</nav>
